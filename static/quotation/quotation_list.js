...
(function(){
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    if (exportBtn) exportBtn.addEventListener('click', function(e){
      e.preventDefault();
      const rows = [['Quotation No','Consumer','Type','Project','Capacity(kW)','PO','PO Date','Status']];
    ...
    // Confirm modal submit handler (for confirmModal)
    ...
    if (confirmForm) {
      confirmForm.addEventListener('submit', function(e){
        ...
        if (!qId) {
          // try to extract from hidden input or form dataset
        }
